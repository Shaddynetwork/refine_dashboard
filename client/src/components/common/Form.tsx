import { Box,Typography,FormControl, 
       ...
       Stack, Select, MenuItem, Button } from '@mui/material';

import {FormProps} from 'interfaces/common';
import CustomButton from './CustomButton';
import { fontSize, fontWeight } from '@pankod/refine-mui';


const Form = ({type, register, handleSubmit,onFinishHandler,formLoading, propertyImage,handleImageChange}:FormProps) => {
  return (
    <Box>
     <Typography
      fontSize={25}
           ...
           <Stack direction="row" gap={4}> 
            ...
            <Select
              ...
              {...register('propertyType',{
                ...
                <MenuItem
                 value="apartment"> Farmhouse
                </MenuItem>
                <MenuItem
                 value="apartment"> Condos
                </MenuItem>
                <MenuItem
